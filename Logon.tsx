...
function Logon() {
    return (
      ...
      <div className='flex flex-col text-gray-400 py-2'>
        <p><a href="/Forgot"></a>Forgot password?</p>
      </div>
        ...
        <button    className='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 '>Log In</button>
        <button    className='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 '><a href="/Form" ></a>Create Account</button>
